...
return {
  ...
  keys = {
    ...
    { "<leader>tt", "<cmd>terminal<cr>", desc = "Open terminal in new buffer" },
    {
      "<leader>tp",
      function()
        toggle_term_cmd({ hidden = true, cmd = "python", display_name = "Python" })
      end,
    ...
    },
    {
      "<leader>tn",
      function()
        toggle_term_cmd({ hidden = true, cmd = "node", display_name = "NodeJS" })
      end,
    ...
    },
    {
      "<leader>tr",
      function()
        toggle_term_cmd({ hidden = true, cmd = "evcxr", display_name = "evcxr repl" })
      end,
    ...
    },
    {
      "<leader>tb",
      function()
        toggle_term_cmd({ hidden = true, cmd = "btop", direction = "float", display_name = "Btop" })
      end,
